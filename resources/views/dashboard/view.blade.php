...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post p-4 h-100">
                        ...
                        <p class="link-url mb-2">
                            <a href="{{ $link['link'] }}" onclick="count_view()" target="_blank">{{ $link['link'] }}</a>
                        </p>
                        <p class="mb-1">{{ $link['link_description'] ?? 'No description available.' }}</p>
                        <div class="post-meta mt-3">
                            <div><strong>Views:</strong> {{ $link['views'] }}</div>
                            <input type="hidden" id="views_id" value="{{ $link['id'] }}">
                            <input type="hidden" id="username" value="{{ $link['username'] }}">
            ...
            <script>
                function count_view() {
                    var views_id = document.getElementById('views_id').value;
